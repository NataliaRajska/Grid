...
![url text](https://github.com/NataliaRajska/Grid/blob/main/resources/css_grid_diagram_2.svg)
...
+ grid-template-columns defines the number and sizes of the columns of the gridv
